...
class AdCreateForm(forms.ModelForm, FormControlsMixin):
    classes = {
        ...
        'image_main': 'ad-form-field integer-field',
        'image1': 'ad-form-field integer-field',
        'image2': 'ad-form-field integer-field',
        'image3': 'ad-form-field integer-field',
        'fuel': 'ad-form-field choice-field',
    ...
    class Meta:
        ...
        fields = (
            ...
            'fuel', 'body_type', 'transmission', 'city', 'horse_power', 'mileage', 'image_main', 'image1', 'image2',
            'image3', 'description'
        )
